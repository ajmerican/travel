<?php
	...
	//$login->autologin();
	if(isset($_POST) && isset($_POST['book']) && $_POST['book'] == 'Book'){
		$_SESSION[SESSION_PREFIX.'booking_data'] = $_POST;
	}

	include_once 'header.php';

	//$result = $obj->bookFlights($_POST['from_city'], $_POST['to_city'], $_POST['date'], $_POST['time_to'], $_POST['flight_id'], $_POST['flight_code'], $_POST['ResBookDesigCode']);
?>
<div class='container'>
                                            ...
                                            <table class="table table-striped" style="font-weight: bold;">
                                                <tr>
                                                    <td style="width: 175px;">
                                                        <label for="id_email">Best Email:</label>
                                                    </td>
                                                    <td>
